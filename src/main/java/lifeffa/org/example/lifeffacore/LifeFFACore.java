...
//        getServer().getPluginManager().registerEvents(new DailyMissionListener(), this);
        ...
        Objects.requireNonNull(getServer().getPluginCommand("ffacheckitem")).setExecutor(new ItemCheckCommand());
        Objects.requireNonNull(getServer().getPluginCommand("checkpoints")).setExecutor(new CheckPointsCommand());
